...
$user_check_query="select *from department where firstname='$fname'or email='$email' limit 1";
...
if (count($err)===0){
    $query="insert into department(firstname,lastname,email,departments,sex,password)values('$fname','$lname','$email','$department','$sex','$pass1')";
...
<body>
    ...
    <div class="box2">
        ...
        <form action="signup.php"method="post">
            ...
            <input type="text" name="departments" id="" placeholder="enter department " required>
            <label >sex</label>
            ...
            Already a member? <a href="Dept_login.php" style="color:#ffc107;">LOGIN</a>
